...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isMyServiceRunning()) {
            ...
            stopService(new Intent(VideoActivity.this, FloatingWindow.class));
        }
        ...
        minimizeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  Intent intent = new Intent(VideoActivity.this, FloatingWindow.class);
               ...
               // Intent launchIntent = getPackageManager().getLaunchIntentForPackage("com.esark.test_shadow.TestActivity");
                ...
                if (checkOverlayDisplayPermission()) {
                    ...
                    startService(new Intent(VideoActivity.this, FloatingWindow.class));
